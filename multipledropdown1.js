window.addEventListener('load', function() {
  ...
  document.addEventListener('click', function(event) {
    ...
    document.querySelectorAll('.mdropdown1-content').forEach(function(el) {
    ...
    if (event.target.matches('.mdropbtn1')) {
      event.target.closest('.mdropdown1').querySelector('.mdropdown1-content').classList.toggle('show1')
    }
